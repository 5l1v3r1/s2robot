...
import org.codelibs.robot.client.ftp.FtpClient.FtpInfo;
 ...
 * 
 */
public class FtpClientTest extends S2TestCase {
    ...
    public FtpServer startFtpServer(int port, String username, String password)
            throws FtpException {
    ...
    public void test_doGet_root_dir() throws FtpException {
        ...
        try {
            ...
            for (final RequestData requestData : urlSet
                ...
                assertTrue(url.contains("dir1") || url.contains("dir2")
                    || url.contains("text1.txt") || url.contains("text2.txt")
    ...
    public void test_doGet_file() throws Exception {
        ...
        try {
            ...
            final ResponseData responseData =
                ftpClient.doGet("ftp://localhost:" + FTP_PORT + "/text1.txt");
    ...
    public void test_doGet_file_with_space() throws Exception {
        ...
        try {
            ...
            ftpClient.setInitParameterMap(params);
            final ResponseData responseData =
                ftpClient.doGet("ftp://localhost:" + FTP_PORT + "/text 3.txt");
            assertEquals(200, responseData.getHttpStatusCode());
            assertEquals("UTF-8", responseData.getCharSet());
    ...
    public void test_doHead_file() throws Exception {
        ...
        try {
            ...
            ftpClient.setInitParameterMap(params);
            final ResponseData responseData =
                ftpClient.doHead("ftp://localhost:" + FTP_PORT + "/text1.txt");
            assertNotNull(responseData.getLastModified());
    ...
    public void test_doHead_root_dir() throws Exception {
        ...
        try {
            ...
            ftpClient.setInitParameterMap(params);
            final ResponseData responseData =
                ftpClient.doHead("ftp://localhost:" + FTP_PORT + "/");
    ...
    public void test_doHead_dir1() throws Exception {
        ...
        try {
            ...
            ftpClient.setInitParameterMap(params);
            final ResponseData responseData =
                ftpClient.doHead("ftp://localhost:" + FTP_PORT + "/dir1");
            assertNull(responseData);
        } finally {
            if (server != null) {
                server.stop();
